  ...
  return (
    <div className='productdisplay'>
        ...
        <div className="productdisplay-right">
            ...
            <div className="productdisplay-right-description">Experience the perfect blend of innovation and quality, designed to simplify your life. Built for durability and style, it’s the ultimate choice for everyday use.</div>
